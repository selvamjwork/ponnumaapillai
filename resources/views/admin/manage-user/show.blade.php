...
@section('title') Manage View User @endsection
                      ...
                      <div class="card-body">
                          <ul class="list-group list-group-unbordered mb-3">
                              <div class="row">
                                  ...
                                  <div class="col-md-6 pb-1">
                                      <li class="list-group-item"> <strong>Profile Created</strong> <a class="float-right">{{$user->created_at->day}}-{{$user->created_at->month}}-{{$user->created_at->year}}</a> </li>
                                  </div>
                              </div>
                              <div class="row">
                                  <div class="col-md-6 pb-1">
