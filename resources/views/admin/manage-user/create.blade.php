...
@section('title') Manage Create User @endsection
...
<div class="content-wrapper">
    ...
    <form class="was-validated" method="POST" action="{{ url('/admin/manage-user') }}">
              {{ csrf_field() }}
                ...
                <div class="col-md-9 offset-md-2">
                            ...
                            <div>
                                <div class="form-group row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        {!! Form::text('name', null, ['required' => 'required','placeholder'=>'Name (பெயர்)','class' => 'form-control']) !!}
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="height" onkeyup="checkInput(this)"/ maxlength="3" placeholder="Height (உயரம்) in CM" required class="form-control">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" name="weight" tonkeyup="checkInput(this)"/ maxlength="3" required placeholder="Weight (எடை) in KG"  class="form-control">
                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="password" class="control-label">Password (கடவுச்சொல்)</label>
                                    {!! Form::text('password', null, ['required' => 'required','placeholder'=>'Password (கடவுச்சொல்)','class' => 'form-control']) !!} {!! $errors->first('password', '<p class="help-block">:message</p>') !!}
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-12">
                            ...
                            <div class="form-group row{{ $errors->has('gender') ? ' has-error ': '' }}">
                                <label for="gender" class="col-sm-3 col-form-label">Payment <span><i class="glyphicon glyphicon-asterisk text-danger"></i></span></label>
                                <div class="col-xl-9 col-sm-9">
                                    <label class="radio-inline">{!! Form::radio('payment_completed', '1', 'required') !!}Yes</label>
                                    <label class="radio-inline ml-3">{!! Form::radio('payment_completed', '0', 'required') !!}No</label>
                                </div>
                            </div>
