...
@section('title') Manage Edit User @endsection
...
<div class="content-wrapper">
    ...
    {!! Form::model($user, ['method' => 'PATCH','url' => ['/admin/manage-user', $user->id],'class' => 'basic_validate','files' => true ]) !!}
    {{ csrf_field() }}
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9 offset-md-2">
                                ...
                                <div class="form-group row{{ $errors->has('gender') ? ' has-error ': '' }}">
                                    ...
                                    <div class="col-xl-9 col-sm-9">
                                        <label class="radio-inline">
                                            Male
                                            {!! Form::radio('gender', '1', ['required' => 'required']) !!}
                                        </label>
                                        <label class="radio-inline ml-3">
                                            {!! Form::radio('gender', '2', ['required' => 'required']) !!}
                                            Female
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Horoscopes - ஜாதகம் <a class="pull-right" href="/admin/update-horoscope/{{$user->id}}">Edit Horoscopes</a></h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
