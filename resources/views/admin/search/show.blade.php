                    ...
                    <div class="widget-box">
                        ...
                        <div class="span10">
                            <table>
                                <tbody>
                                    <tr>
                                        <td colspan="7" style="background-color: #c32143;color: white;FONT-SIZE: 25px;font-weight: bold; text-align:left;"> {!! $us->user_id !!} - {{$us->nameRange}}.{!! $us->name !!}  <a class="pull-right btn" href="{{ url('/admin/profile/search/' . $us->id) }}">View Profile</a></td>
                                    </tr>
                                    <tr bgcolor="#f1f1f1">
