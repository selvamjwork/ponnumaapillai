                    ...
                    <div class="card card-danger">
                        ...
                        <div class="card-body">
                            <div class="card-header bg-white mt-2">
                                {!! Form::model($contect, ['method' => 'PATCH','url' => ['/admin/contectus', $contect->id],'files' => true ]) !!}
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row ">
                                        <div class="offset-xl-5 col-xl-1 offset-lg-4 col-lg-1 col-md-1 offset-md-4 offset-sm-4 col-sm-1 offset-3 col-2">
                                            <button type="submit" class="btn btn-success">Update Contect Us Details</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
