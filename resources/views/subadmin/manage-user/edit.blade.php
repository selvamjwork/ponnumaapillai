...
<div class="content-wrapper">
    ...
    {!! Form::model($user, ['method' => 'PATCH','url' => ['/subadmin/manage-user', $user->id],'class' => 'basic_validate','files' => true ]) !!}
    {{ csrf_field() }}
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-9 offset-md-2">
                    ...
                    <div class="card card-danger">
                        <div class="card-header">
                            <h3 class="card-title">Horoscopes - ஜாதகம் <a class="pull-right" href="/subadmin/update-horoscope/{{$user->id}}">Edit Horoscopes</a></h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
