...
@extends('layouts.app')
@section('page_name') Interested Profile @endsection
        ...
        <div class="container-fluid">
            ...
            <div class="card  card-danger card-outline card-widget widget-user ">
                ...
                <div class="card-footer">
                    ...
                    <div class="row">
                        <div class="col-md-6"><a class="float-sm-left da text-danger" href="/interestedprofile/{{$us->id}}"><!-- I'm Interested <em class="fa fa fa-forward" aria-hidden="true"></em></a> --></div>
                        <div class="col-md-6"><a class="float-sm-right da text-danger" href="/interestprofile/{{$us->id}}">View Profile <em class="fa fa fa-forward" aria-hidden="true"></em></a></div>
                    </div>
                </div>
            </div>
            @endforeach
